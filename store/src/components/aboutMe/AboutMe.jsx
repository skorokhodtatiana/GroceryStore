...
const AboutMe = () => {
	return (
		<div className='wrapper-aboutMe'>
			...
			<div className='wrapper-aboutMe__content'>
				<h2>Как все начиналось</h2>
				<p className='wrapper-aboutMe__text'>Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века. 
